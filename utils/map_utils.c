...
/*   Updated: 2026/02/02 22:41:34 by msokolov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool    map_down_check(t_data *data, size_t x, size_t y)
{
    ...
    if (y > 0 && x < ft_strlen(data->map[y-1]) && (data->map[y - 1][x] == '0' || data->map[y - 1][x] == 'P' || data->map[y - 1][x] == 'D'))
        return (printf("Map is not covered by the walls\n"), false);
...
bool	map_right_check(t_data *data, size_t x, size_t y)
{
	...
	if (data->map[y][x - 1] == '0' || data->map[y][x - 1] == 'P'|| data->map[y][x - 1] == 'D')
        return (printf("Map is not covered by the walls\n"), false);
...
{
    if (x + 1 < ft_strlen(data->map[y]) && (data->map[y][x + 1] == '0' || data->map[y][x + 1] == 'P' || data->map[y][x + 1] == 'D'))
        return (printf("Map is not covered by the walls\n"), false);
    if (x + 1 < ft_strlen(data->map[y]) && data->map[y][x + 1] == '1')
    {
        ...
        if (data->map[y][x] == '1')
            return(true);
        if (data->map[y][x] == 'P' || data->map[y][x] == '0' || data->map[y][x] == 'D')
            return (printf("Map is not covered by the walls\n"), false);
    }
    return(true);
}
